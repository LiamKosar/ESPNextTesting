      ...
      <CardContent>
        ...
        <Collapsible className="my-4" defaultOpen={true}>
          ...
          <CollapsibleContent
            ...
            className="my-2 mt-3 px-3 grid gap-4 md:grid-cols-2 lg:grid-cols-2 overflow-scroll overscroll-none"
          >
            {vehicle.maintenanceProcedures?.map(
        ...
        {connectedDevice ? (
          <div className="relative my-4">
            <span className="absolute flex justify-end p-4 top-0 right-0">
              <DeleteButton
                onClick={() => deleteVehichleDeviceConnection()}
              ></DeleteButton>
            </span>
